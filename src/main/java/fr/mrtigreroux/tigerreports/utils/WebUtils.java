...
public class WebUtils {
    ...
    public static void checkNewVersion(Plugin plugin, TaskScheduler taskScheduler, String resourceId,
                                       ResultCallback<String> resultCallback) {
        taskScheduler.runTaskAsynchronously(new Runnable() {

            @Override
            public void run() {
                String queryResult = sendQuery("https://api.spigotmc.org/legacy/update.php?resource=" + resourceId,
                        null);
                ...
                taskScheduler.runTask(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (newVersion != null) {
                            ...
                            logger.warning("https://www.spigotmc.org/resources/" + pluginName.toLowerCase() + "."
                                    + resourceId + "/");
                            logger.warning(MessageUtils.LINE);
                        }
