...
class CollectionUtilsTest {
	...
	void testToString() {
		...
		listOfLists.add(list1);
		listOfLists.add(list2);
		String listOfListsStr = "[" + list1Str + ", " + list2Str + ", " + list3Str + ", " + list1Str + ", " + list2Str
		        + "](5)";
		...
		map2.put(2, list3);
		map2.put(3, list2);
		String map2Str = "[0: " + list1Str + ", 1: " + list2Str + ", 2: " + list3Str + ", 3: " + list2Str + "](4)";
	...
	/**
	 * Test method for {@link fr.mrtigreroux.tigerreports.utils.CollectionUtils#reversedList(java.util.List)}.
	 */
	@Test
